import {Button, ButtonGroup, Card, CardGroup, Carousel, CloseButton, Figure} from "react-bootstrap";
        ...
        return(
            <>
                <Card style={{ width: '18rem' }} border="primary" text="warning">
                    <Card.Img variant="top" src="https://images.unsplash.com/photo-1653792892136-69825f302a78?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80" />
                    <Card.Body>
                ...
                <Card className="bg-dark text-white">
                    <Card.Img src="https://images.unsplash.com/photo-1653792892136-69825f302a78?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80" alt="Card image" />
                    <Card.ImgOverlay>
                        <Card.Title>Card title</Card.Title>
                        <Card.Text>
        ...
        return(
            <>
                <Carousel activeIndex={index}
                          ...
                          onSelect={handleSelect} fade interval={1000} variant="dark" controls={false}
                          indicators={false}
                >
                    <Carousel.Item>
                        <img
