                ...
                <>
                    ...
                    <Form onSubmit={(e)=>{
                        ...
                        <Form.Group className="mb-3" controlId="formBasicPassword">
                            ...
                            <Form.Control plaintext  readOnly  value={state} onChange={(e)=>{setState(e.target.value)}} type="password" placeholder="Password" />
                        </Form.Group>
                    ...
                    <InputGroup>
                        ...
                        <InputGroup size="sm" className="mb-3" >
                            ...
                            <FormControl isValid aria-label="Small" aria-describedby="inputGroup-sizing-sm" />
                        </InputGroup>
                        <br />
                        <InputGroup className="mb-3">
